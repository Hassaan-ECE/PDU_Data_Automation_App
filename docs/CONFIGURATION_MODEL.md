...
Some workflow values are report-layout targets and should become config-driven later. For now, the backend implements the Transformer SN setup/save writes directly in setup commands:
